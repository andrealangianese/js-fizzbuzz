...
for (let i = 1; i < 101; i++) {
    ...
    if (i % 3 === 0 && i % 5 === 0) {
        ...
        listItems += `<li> ${i} questi sono i più fighi</li>`
    }
    // al posto dei multipli di 3 (3,6,9,12...) deve stampare "fizz" al posto dei numeri
    else if (i % 3 === 0) {
        console.log("fizz");
        listItems += `<li>${i} quest'altri li chiamiamo ${"fizz"} e sarebbero i multipli di 3</li>`
    } // al posto dei multipli di 5 (5,10,15,20) deve stampare "buzz" al posto dei numeri
    else if (i % 5 === 0) {
        console.log("buzz");
        listItems += `<li>${i} questi sono i numeri ${"buzz"}, ossia i multipli di 5 </li>`
    } //per stampare gli altri numeri 
    else {
        console.log(i);
        listItems = listItems + `<li>${i} Questi sono i numeri non divisibili per 3 nè per 5</li>`   
    }

}
console.log(listItems);
mialista.innerHTML = listItems
